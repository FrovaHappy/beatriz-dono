...
const urls = {
  ...
  oAuth: `https://discord.com/oauth2/authorize?client_id=${applicationId}&response_type=code&redirect_uri=${encodeURIComponent(`${urlApi}/callback/discord`)}&scope=email+guilds+identify`,
  api: urlApi,
